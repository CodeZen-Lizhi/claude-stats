...
/// deck that slides between app and settings navigation while the detail panel
...
struct MainWindowModeShell<AppSidebar: View, SettingsSidebar: View, AppDetail: View, SettingsDetail: View>: View {
    ...
    private var sidebarDeck: some View {
        ...
        .frame(
            width: MainWindowMotion.appSidebarWidth + MainWindowMotion.settingsSidebarWidth,
            alignment: .leading
        )
