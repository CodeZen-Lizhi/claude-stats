...
/// Small "Today / 7d / 30d / All" chips at the top-right of the Dashboard.
...
struct RangeChips: View {
    ...
    /// The chips we surface here, in display order.
    static let supported: [StatsPeriod] = [.today, .last7Days, .last30Days, .allTime]
