...
### Package: ThirdParty/Rockxy (`spec/ThirdParty/Rockxy/`)

- Backend guidelines: `.trellis/spec/ThirdParty/Rockxy/backend/`

- Frontend guidelines: `.trellis/spec/ThirdParty/Rockxy/frontend/`
